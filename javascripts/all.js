...
function mce_init_form(){
    jQuery(document).ready( function($) {
      ...
      options = { url: 'http://itsbspoke.us2.list-manage.com/subscribe/post-json?u=8b4656bd4a093a3bcabfda08a&id=0246c7f1fb&c=?', type: 'GET', dataType: 'json', contentType: "application/json; charset=utf-8",
